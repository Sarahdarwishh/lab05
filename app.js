...
function sumArray(sumArr) { //eslint-disable-line
    let sum_array = sum(sumArr[0],sumArr[1])[0];
    console.log(sum_array)
    sum_array = sum(sum_array,sumArr[2])[0];
    console.log(sum_array)
...
let productx =multiply(multArr[0],multArr[1])[0];
console.log(productx)
productx = multiply(productx,multArr[2])[0];
console.log(productx)
return[productx ,`The numbers ${multArr[0]},${multArr[1]},${multArr[2]} have a product of ${productx}.`]
}
